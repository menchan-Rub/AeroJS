...
JsonValue::JsonValue()
    : type(JsonValueType::kNull), allocated(false) {
...
JsonValue::JsonValue(bool boolean_value)
    : type(JsonValueType::kBoolean), allocated(false) {
  value.boolean_value = boolean_value;
}

JsonValue::JsonValue(double number_value)
    : type(JsonValueType::kNumber), allocated(false) {
  value.number_value = number_value;
}

JsonValue::JsonValue(const std::string& string_value)
    : type(JsonValueType::kString), allocated(true) {
  value.string_value = new std::string(string_value);
}

JsonValue::JsonValue(const char* string_value)
    : type(JsonValueType::kString), allocated(true) {
  value.string_value = new std::string(string_value);
}

JsonValue::JsonValue(const JsonValue& other)
    : type(other.type), allocated(false) {
  switch (type) {
    case JsonValueType::kNull:
      value.null_value = nullptr;
      break;
...
JsonValue::JsonValue(JsonValue&& other) noexcept
    : type(other.type), value(other.value), allocated(other.allocated) {
...
JsonParser::JsonParser(const JsonParserOptions& options)
    : options_(options) {
}
