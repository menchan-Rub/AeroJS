...
nlohmann::json Property::toJson(bool pretty) const {
    ...
    switch(m_kind) {
        case PropertyKind::Init: jsonNode["kind"] = "init"; break;
        case PropertyKind::Get:  jsonNode["kind"] = "get"; break;
        case PropertyKind::Set:  jsonNode["kind"] = "set"; break;
    }
    return jsonNode;
}
...
std::string Property::toString() const {
    ...
    std::string kindStr;
     switch(m_kind) {
        case PropertyKind::Init: kindStr = "init"; break;
        case PropertyKind::Get:  kindStr = "get"; break;
        case PropertyKind::Set:  kindStr = "set"; break;
    }
