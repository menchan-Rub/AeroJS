...
const std::optional<std::unique_ptr<Identifier>>& ClassExpression::getId() const {
  return m_id;
}
const std::optional<std::unique_ptr<ExpressionNode>>& ClassExpression::getSuperClass() const {
  return m_superClass;
}
const ClassBody& ClassExpression::getBody() const {
  return *m_body;
}
ClassBody& ClassExpression::getBody() {
  return *m_body;
}
...
void ClassExpression::accept(ConstAstVisitor& visitor) const {
  visitor.Visit(*this);
}
...
std::string ClassExpression::toString() const {
