...
const TemplateElementValue& TemplateElement::getValue() const { return m_value; }
bool TemplateElement::isTail() const noexcept { return m_tail; }

void TemplateElement::accept(AstVisitor& visitor) { visitor.Visit(*this); }
void TemplateElement::accept(ConstAstVisitor& visitor) const { visitor.Visit(*this); }

std::vector<Node*> TemplateElement::getChildren() { return {}; }
std::vector<const Node*> TemplateElement::getChildren() const { return {}; }
...
std::string TemplateElement::toString() const { return "TemplateElement<raw:'" + m_value.raw + "'>"; }
...
const TemplateLiteral::ElementList& TemplateLiteral::getQuasis() const { return m_quasis; }
const TemplateLiteral::ExpressionList& TemplateLiteral::getExpressions() const { return m_expressions; }

void TemplateLiteral::accept(AstVisitor& visitor) { visitor.Visit(*this); }
void TemplateLiteral::accept(ConstAstVisitor& visitor) const { visitor.Visit(*this); }
...
std::string TemplateLiteral::toString() const { return "TemplateLiteral"; }
...
const ExpressionNode& TaggedTemplateExpression::getTag() const { return *m_tag; }
ExpressionNode& TaggedTemplateExpression::getTag() { return *m_tag; }
const TemplateLiteral& TaggedTemplateExpression::getQuasi() const { return *m_quasi; }
TemplateLiteral& TaggedTemplateExpression::getQuasi() { return *m_quasi; }

void TaggedTemplateExpression::accept(AstVisitor& visitor) { visitor.Visit(*this); }
void TaggedTemplateExpression::accept(ConstAstVisitor& visitor) const { visitor.Visit(*this); }

std::vector<Node*> TaggedTemplateExpression::getChildren() { return {m_tag.get(), m_quasi.get()}; }
std::vector<const Node*> TaggedTemplateExpression::getChildren() const { return {m_tag.get(), m_quasi.get()}; }
...
std::string TaggedTemplateExpression::toString() const { return "TaggedTemplateExpression"; }
