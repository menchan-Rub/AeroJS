...
const ExpressionNode& SpreadElement::getArgument() const {
  return *m_argument;
}
ExpressionNode& SpreadElement::getArgument() {
  return *m_argument;
}
void SpreadElement::accept(AstVisitor& visitor) {
  visitor.Visit(*this);
}
void SpreadElement::accept(ConstAstVisitor& visitor) const {
  visitor.Visit(*this);
}
std::vector<Node*> SpreadElement::getChildren() {
  return {m_argument.get()};
}
std::vector<const Node*> SpreadElement::getChildren() const {
  return {m_argument.get()};
}
...
std::string SpreadElement::toString() const {
  return "SpreadElement<arg:" + m_argument->toString() + ">";
}
...
const PatternNode& RestElement::getArgument() const {
  return *m_argument;
}
PatternNode& RestElement::getArgument() {
  return *m_argument;
}
void RestElement::accept(AstVisitor& visitor) {
  visitor.Visit(*this);
}
void RestElement::accept(ConstAstVisitor& visitor) const {
  visitor.Visit(*this);
}
std::vector<Node*> RestElement::getChildren() {
  return {m_argument.get()};
}
std::vector<const Node*> RestElement::getChildren() const {
  return {m_argument.get()};
}
...
std::string RestElement::toString() const {
  return "RestElement<arg:" + m_argument->toString() + ">";
}
