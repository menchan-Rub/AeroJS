...
struct PropertyDescriptor {
  ...
  bool isAccessor() const {
    return (attributes & PropertyAttribute::Accessor) != 0;
  }
  bool isWritable() const {
    return (attributes & PropertyAttribute::Writable) != 0;
  }
  bool isEnumerable() const {
    return (attributes & PropertyAttribute::Enumerable) != 0;
  }
  bool isConfigurable() const {
    return (attributes & PropertyAttribute::Configurable) != 0;
  }
};
...
class PropertyKey {
 public:
  ...
  PropertyKey()
      : m_type(Integer), m_intKey(0) {
  }

  PropertyKey(uint32_t index)
      : m_type(Integer), m_intKey(index) {
  }

  PropertyKey(const std::string& str)
      : m_type(String), m_stringKey(str) {
  }

  PropertyKey(const utils::StringView& view)
      : m_type(String), m_stringKey(view.toString()) {
  }

  PropertyKey(class Symbol* sym)
      : m_type(Symbol), m_symbolPtr(sym) {
  }
...
class Object : public utils::RefCounted {
 public:
  ...
  bool isRegExp() const {
    return getType() == Type::RegExp;
  }
  bool isError() const {
    return getType() == Type::Error;
  }
  bool isBigInt() const {
    return getType() == Type::BigInt;
  }
  bool isMap() const {
    return getType() == Type::Map;
  }
  bool isSet() const {
    return getType() == Type::Set;
  }
  bool isPromise() const {
    return getType() == Type::Promise;
  }
  bool isProxy() const {
    return getType() == Type::Proxy;
  }
  bool isTypedArray() const {
    return getType() == Type::TypedArray;
  }
  bool isArrayBuffer() const {
    return getType() == Type::ArrayBuffer;
  }
  bool isDataView() const {
    return getType() == Type::DataView;
  }
