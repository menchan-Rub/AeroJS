/**
 * @file arm64_ic_generator.h
 * @brief ARM64アーキテクチャ向けのインラインキャッシュコード生成
 * @version 1.0.0
 * @license MIT
 */
...
/**
 * @brief ARM64アーキテクチャ向けのインラインキャッシュコード生成クラス
 * 
 * このクラスはARM64プロセッサ向けのインラインキャッシュスタブコードを生成します。
 */
class ARM64_ICGenerator {
public:
    /**
