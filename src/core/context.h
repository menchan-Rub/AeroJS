...
public:
     ...
     */
    Exception* getLastException() const { return m_lastException; }
     ...
     * @return 現在のスコープ
     */
    Scope* getCurrentScope() const { return m_currentScope; }
     ...
     */
    JITCompiler* getJITCompiler() const { return m_jitCompiler; }
