...
class BytecodeInstruction {
 public:
   ...
   */
  BytecodeInstruction()
      : m_opcode(static_cast<uint8_t>(Opcode::kNop)), m_operandCount(0), m_operands{0, 0, 0, 0}, m_sourceLine(0), m_sourceColumn(0) {
  }
  ...
  explicit BytecodeInstruction(Opcode opcode)
      : m_opcode(static_cast<uint8_t>(opcode)), m_operandCount(0), m_operands{0, 0, 0, 0}, m_sourceLine(0), m_sourceColumn(0) {
  }
  ...
  BytecodeInstruction(Opcode opcode, int32_t operand1)
      : m_opcode(static_cast<uint8_t>(opcode)), m_operandCount(1), m_operands{operand1, 0, 0, 0}, m_sourceLine(0), m_sourceColumn(0) {
  }
  ...
  BytecodeInstruction(Opcode opcode, int32_t operand1, int32_t operand2)
      : m_opcode(static_cast<uint8_t>(opcode)), m_operandCount(2), m_operands{operand1, operand2, 0, 0}, m_sourceLine(0), m_sourceColumn(0) {
  }
  ...
  BytecodeInstruction(Opcode opcode, int32_t operand1, int32_t operand2, int32_t operand3)
      : m_opcode(static_cast<uint8_t>(opcode)), m_operandCount(3), m_operands{operand1, operand2, operand3, 0}, m_sourceLine(0), m_sourceColumn(0) {
  }
  ...
  BytecodeInstruction(Opcode opcode, int32_t operand1, int32_t operand2, int32_t operand3, int32_t operand4)
      : m_opcode(static_cast<uint8_t>(opcode)), m_operandCount(4), m_operands{operand1, operand2, operand3, operand4}, m_sourceLine(0), m_sourceColumn(0) {
  }
