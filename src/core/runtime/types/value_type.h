...
inline std::string valueTypeToString(ValueType type) {
    switch (type) {
        ...
        case ValueType::WeakMap: return "weakmap";
        case ValueType::WeakSet: return "weakset";
        case ValueType::ArrayBuffer: return "arraybuffer";
        case ValueType::SharedArrayBuffer: return "sharedarraybuffer";
        case ValueType::DataView: return "dataview";
        case ValueType::TypedArray: return "typedarray";
        case ValueType::Promise: return "promise";
        case ValueType::Proxy: return "proxy";
        case ValueType::Error: return "error";
        
        case ValueType::Internal: return "internal";
        case ValueType::Empty: return "empty";
        case ValueType::Deleted: return "deleted";
...
inline std::string errorTypeToString(ErrorType type) {
    switch (type) {
        ...
        case ErrorType::AggregateError: return "AggregateError";
...
inline std::string typedArrayTypeToString(TypedArrayType type) {
    switch (type) {
        case TypedArrayType::Int8Array: return "Int8Array";
        case TypedArrayType::Uint8Array: return "Uint8Array";
        case TypedArrayType::Uint8ClampedArray: return "Uint8ClampedArray";
        case TypedArrayType::Int16Array: return "Int16Array";
        case TypedArrayType::Uint16Array: return "Uint16Array";
        case TypedArrayType::Int32Array: return "Int32Array";
        case TypedArrayType::Uint32Array: return "Uint32Array";
        case TypedArrayType::Float32Array: return "Float32Array";
        case TypedArrayType::Float64Array: return "Float64Array";
        case TypedArrayType::BigInt64Array: return "BigInt64Array";
        case TypedArrayType::BigUint64Array: return "BigUint64Array";
