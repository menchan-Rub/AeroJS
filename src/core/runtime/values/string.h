...
class String : public utils::RefCounted {
 public:
   ...
   */
  String()
      : length_(0), utf8Length_(0), storageType_(StorageType::Small) {
    small_.data[0] = '\0';
  }
   ...
   */
  bool isSmall() const {
    return storageType_ == StorageType::Small;
  }
   ...
   */
  bool isNormal() const {
    return storageType_ == StorageType::Normal;
  }
   ...
   */
  bool isStatic() const {
    return storageType_ == StorageType::Static;
  }
   ...
   */
  bool isSliced() const {
    return storageType_ == StorageType::Sliced;
  }
  ...
  bool isConcatenated() const {
    return storageType_ == StorageType::Concatenated;
  }
